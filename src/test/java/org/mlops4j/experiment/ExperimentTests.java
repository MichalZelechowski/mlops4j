...
public class ExperimentTests {
    ...
    @Test
    public void experimentIsRun() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        Experiment experiment = new Experiment.Builder().model(model).build();
